...
public class DrinksController : ControllerBase
{
    ...
    private static readonly List<Drink> Drinks = new()
    {
        ...
        new Drink { Id = 3, Name = "Red Bull", Quantity = 5, Threshold = 3, ImageUrl = "https://dummyimage.com/100x100/000/fff&text=RedBull" },
        new Drink { Id = 4, Name = "Coca Cola", Quantity = 20, Threshold = 10, ImageUrl = "https://dummyimage.com/100x100/000/fff&text=CocaCola" }
    };
